...
Плагин позволяет игрокам выполнять двойные прыжки в CS2. Поддерживается прыжок в воздухе при падении (air jump) с возможностью настройки высоты, количества прыжков и множителя.
